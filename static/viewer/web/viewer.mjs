        ...
        const PDFViewerApplication = {
          ...
          async initialize(appConfig) {
            ...
            if (
              ...
              _app_options_js__WEBPACK_IMPORTED_MODULE_2__.AppOptions.get('externalLinkTarget') === _pdf_link_service_js__WEBPACK_IMPORTED_MODULE_4__.LinkTarget.NONE
            ) {
          ...
          async _initializeViewerComponents() {
            ...
            const pageColors =
              _app_options_js__WEBPACK_IMPORTED_MODULE_2__.AppOptions.get('forcePageColors') || window.matchMedia('(forced-colors: active)').matches
                ? {
            ...
            const altTextManager = appConfig.altTextDialog
              ? new web_alt_text_manager__WEBPACK_IMPORTED_MODULE_5__.AltTextManager(appConfig.altTextDialog, container, this.overlayManager, eventBus)
              : null
          ...
          load(pdfDocument) {
            ...
            firstPagePromise.then((pdfPage) => {
              ...
              Promise.all([_ui_utils_js__WEBPACK_IMPORTED_MODULE_0__.animationStarted, storedPromise, pageLayoutPromise, pageModePromise, openActionPromise])
    ...
    __webpack_require__.a(__webpack_module__, async (__webpack_handle_async_dependencies__, __webpack_async_result__) => {
      try {
        ...
        const DIACRITICS_EXCEPTION = new Set([
          0x3099, 0x309a, 0x094d, 0x09cd, 0x0a4d, 0x0acd, 0x0b4d, 0x0bcd, 0x0c4d, 0x0ccd, 0x0d3b, 0x0d3c, 0x0d4d, 0x0dca, 0x0e3a, 0x0eba, 0x0f84, 0x1039, 0x103a, 0x1714, 0x1734,
          0x17d2, 0x1a60, 0x1b44, 0x1baa, 0x1bab, 0x1bf2, 0x1bf3, 0x2d7f, 0xa806, 0xa82c, 0xa8c4, 0xa953, 0xa9c0, 0xaaf6, 0xabed, 0x0c56, 0x0f71, 0x0f72, 0x0f7a, 0x0f7b, 0x0f7c,
  ...
  /***/ 1834: /***/ (__webpack_module__, __webpack_exports__, __webpack_require__) => {
    __webpack_require__.a(__webpack_module__, async (__webpack_handle_async_dependencies__, __webpack_async_result__) => {
      try {
        ...
        ;[pdfjs_lib__WEBPACK_IMPORTED_MODULE_0__, _app_js__WEBPACK_IMPORTED_MODULE_1__, _print_utils_js__WEBPACK_IMPORTED_MODULE_2__] = __webpack_async_dependencies__.then
          ? (await __webpack_async_dependencies__)()
          : __webpack_async_dependencies__
        ...
        class PDFViewer {
          ...
          update() {
            ...
            const isSimpleLayout =
              this._spreadMode === _ui_utils_js__WEBPACK_IMPORTED_MODULE_1__.SpreadMode.NONE &&
              (this._scrollMode === _ui_utils_js__WEBPACK_IMPORTED_MODULE_1__.ScrollMode.PAGE || this._scrollMode === _ui_utils_js__WEBPACK_IMPORTED_MODULE_1__.ScrollMode.VERTICAL)
          ...
          forceRendering(currentlyVisiblePages) {
            ...
            const preRenderExtra =
              this._spreadMode !== _ui_utils_js__WEBPACK_IMPORTED_MODULE_1__.SpreadMode.NONE && this._scrollMode !== _ui_utils_js__WEBPACK_IMPORTED_MODULE_1__.ScrollMode.HORIZONTAL
            ...
            div.addEventListener('copy', (event) => {
              if (!this.#enablePermissions) {
                ...
                event.clipboardData.setData(
                  'text/plain',
                  (0, _ui_utils_js__WEBPACK_IMPORTED_MODULE_1__.removeNullCharacters)((0, pdfjs_lib__WEBPACK_IMPORTED_MODULE_0__.normalizeUnicode)(selection.toString()))
                )
              }
              event.preventDefault()
              event.stopPropagation()
  ...
  /***/ 6400: /***/ (__webpack_module__, __webpack_exports__, __webpack_require__) => {
    __webpack_require__.a(__webpack_module__, async (__webpack_handle_async_dependencies__, __webpack_async_result__) => {
      try {
        ...
        ;[web_com__WEBPACK_IMPORTED_MODULE_0__, web_print_service__WEBPACK_IMPORTED_MODULE_1__, _app_js__WEBPACK_IMPORTED_MODULE_5__] = __webpack_async_dependencies__.then
          ? (await __webpack_async_dependencies__)()
          : __webpack_async_dependencies__
